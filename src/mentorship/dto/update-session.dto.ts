...
import { IsString, IsDateString, IsOptional, IsInt, Min, Max, IsBoolean, ValidateIf } from 'class-validator';

export class UpdateSessionDto {
  @ApiPropertyOptional({ description: 'Scheduled date and time for the session' })
  @IsOptional()
  @IsDateString()
  ...
  @ApiPropertyOptional({ description: 'Whether the session is online' })
  @IsOptional()
  @IsBoolean()
  isOnline?: boolean;
